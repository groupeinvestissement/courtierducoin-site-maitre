...
function safeUrl(string $key): string {
    ...
    $allowed = ['www.courtierducoin.ca', 'courtierducoin.ca', 'vaudreuil-soulanges.courtierducoin.ca', 'laval.courtierducoin.ca', 'laval-centre.courtierducoin.ca', 'centre-laval.courtierducoin.ca', 'plateau.courtierducoin.ca', 'sud-ouest.courtierducoin.ca', 'longueuil.courtierducoin.ca', 'mercier-hochelaga.courtierducoin.ca', 'ndg.courtierducoin.ca', 'ouest-ile-nord.courtierducoin.ca', 'ouest-ile-sud.courtierducoin.ca', 'ouest-ile.courtierducoin.ca', 'outremont-westmount-vmr.courtierducoin.ca', 'centre.courtierducoin.ca', 'repentigny.courtierducoin.ca', 'saint-laurent.courtierducoin.ca', 'verdun.courtierducoin.ca', 'ville-marie.courtierducoin.ca'];
    $allowed[] = 'villeray.courtierducoin.ca';
...
// Les pages françaises protégées historiques n'ont pas encore de source_key.
// Leur comportement existant reste accepté; les nouvelles pages anglaises,
// l'Ouest-de-l'Île unifié et les secteurs modernes demeurent autoritaires.
$legacyProtectedRegions = ['ahuntsic-cartierville', 'anjou-saint-leonard', 'cdn-cote-saint-luc', 'lachine-lasalle', 'ile-des-soeurs'];
$legacyProtectedSubmission = $sourceKey === '' && in_array($submittedRegion, $legacyProtectedRegions, true);
if ($sourceKey === '' && ($submittedRegion === 'villeray-saint-michel-parc-extension' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/villeray-saint-michel-parc-extension/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/villeray-saint-michel-parc-extension/')) {
    http_response_code(422);
    echo json_encode(['message'=>'Source du formulaire requise.']);
    exit;
}
if (!$legacyProtectedSubmission && $sourceKey === '' && (clean('region', 80) === 'laval' || $submittedRegion === 'ahuntsic-cartierville' || $submittedRegion === 'anjou-saint-leonard' || $submittedRegion === 'cdn-cote-saint-luc' || $submittedRegion === 'lachine-lasalle' || $submittedRegion === 'ile-des-soeurs' || $submittedRegion === 'le-plateau-mont-royal' || $submittedRegion === 'le-sud-ouest' || $submittedRegion === 'longueuil' || $submittedRegion === 'mercier-hochelaga-maisonneuve' || $submittedRegion === 'ndg-montreal-ouest' || $submittedRegion === 'ouest-de-lile-nord' || $submittedRegion === 'ouest-de-lile-sud' || $submittedRegion === 'ouest-de-lile' || $submittedRegion === 'outremont-westmount-vmr' || $submittedRegion === 'repentigny' || $submittedRegion === 'saint-laurent' || $submittedRegion === 'verdun' || $submittedRegion === 'ville-marie' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/laval/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/laval/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/ahuntsic-cartierville/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/ahuntsic-cartierville/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/anjou-saint-leonard/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/anjou-saint-leonard/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/cdn-cote-saint-luc/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/cdn-cote-saint-luc/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/lachine-lasalle/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/lachine-lasalle/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/ile-des-soeurs/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/ile-des-soeurs/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/le-plateau-mont-royal/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/le-plateau-mont-royal/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/le-sud-ouest/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/le-sud-ouest/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/longueuil/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/longueuil/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/mercier-hochelaga-maisonneuve/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/mercier-hochelaga-maisonneuve/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/ndg-montreal-ouest/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/ndg-montreal-ouest/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/ouest-de-lile-nord/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/ouest-de-lile-nord/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/ouest-de-lile-sud/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/ouest-de-lile-sud/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/ouest-de-lile/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/ouest-de-lile/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/outremont-westmount-vmr/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/outremont-westmount-vmr/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/repentigny/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/repentigny/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/saint-laurent/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/saint-laurent/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/verdun/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/verdun/' || str_starts_with(clean('canonical_url', 1000), 'https://www.courtierducoin.ca/ville-marie/') || clean('canonical_url', 1000) === 'https://www.courtierducoin.ca/secteurs/ville-marie/')) {
    http_response_code(422);
    echo json_encode(['message'=>'Source du formulaire requise.']);
    exit;
}
