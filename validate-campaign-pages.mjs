...
for(const {destination} of redirects){
  ...
  if(!html.includes('<meta name="robots" content="noindex,follow">')&&!['/rosemont-la-petite-patrie/04m44/','/rosemont-la-petite-patrie/05c55/'].includes(url.pathname))errors.push(`${url.pathname}: progressive noindex missing`);
