...
const routes = [
  'https://www.courtierducoin.ca/secteurs/le-plateau-mont-royal/',
  'https://www.courtierducoin.ca/le-plateau-mont-royal/o1a11/',
  'https://www.courtierducoin.ca/le-plateau-mont-royal/02a22/',
  'https://www.courtierducoin.ca/le-plateau-mont-royal/03i33/',
  'https://www.courtierducoin.ca/le-plateau-mont-royal/04m44/',
  'https://www.courtierducoin.ca/le-plateau-mont-royal/05c55/'
];
...
for (const [index, code] of hostRoutes.entries()) {
  const entry = `https://plateau.courtierducoin.ca/${code}`;
  const destination = `${routes[index]}?entry=le-plateau-mont-royal-${code || 'universal'}`;
...
console.log('Updated Plateau sitemap and redirect map.');
