...
const pageText = {
  ...
  accompagnement: {
    ...
    guide: 'Checklist succession',
    guideHeading: () => 'Checklist succession — propriété héritée',
    guideIntro: () => 'Une liste pratique pour organiser les autorisations, les accès, les documents, l’entretien et les décisions.',
    guideButton: 'Recevoir la checklist', analysis: 'Analyser la propriété', final: 'Le dossier de la propriété peut être organisé une étape à la fois.'
  },
  investisseur: {
...
function pageHtml(s, type, code) {
  ...
  const guideHeading = t.guideHeading ? t.guideHeading(s) : `${t.guide} — ${s.name}`;
