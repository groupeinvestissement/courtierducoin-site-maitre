...
function html(page) {
  ...
  const isSpecialized = page.key !== 'universal';
  const heroAsset = isSpecialized ? '/assets/pierre-dalpe-portrait-transparent.png' : `/assets/laval/hero-laval-${page.image}.webp`;
  const heroMedia = isSpecialized
    ? `<div class="rm-hero-photo rm-hero-portrait"><img src="/assets/pierre-dalpe-portrait-transparent.png" alt="Pierre Dalpé, courtier immobilier résidentiel et commercial." width="1254" height="1254" fetchpriority="high"><span>Pierre Dalpé<small>Courtier immobilier résidentiel et commercial</small></span></div>`
    : `<div class="rm-hero-photo"><img src="/assets/laval/hero-laval-${page.image}.webp" alt="${page.alt}" width="1600" height="900" fetchpriority="high"><span>Laval<small>${page.page} · analyse locale avec Pierre Dalpé</small></span></div>`;
  const proofSection = isSpecialized
    ? `<section class="rm-section property-proof-section"><div class="property-proof-copy"><p class="rm-kicker dark">Une lecture locale structurée</p><h2>${page.proofTitle}</h2><p class="intro">${page.proofIntro}</p></div><figure class="property-proof-photo"><img src="/assets/laval/hero-laval-${page.image}.webp" alt="${page.alt}" width="1600" height="900" loading="lazy" decoding="async"><figcaption>${page.page} à Laval</figcaption></figure><div class="local-proof">${cards}</div></section>`
    : `<section class="rm-section"><p class="rm-kicker dark">Une lecture locale structurée</p><h2>${page.proofTitle}</h2><p class="intro">${page.proofIntro}</p><div class="local-proof">${cards}</div></section>`;
  return `<!doctype html>
<html lang="fr-CA"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${page.title}</title><meta name="description" content="${esc(page.description)}"><meta name="robots" content="index,follow,max-image-preview:large"><link rel="canonical" href="${canonical}"><link rel="icon" href="/favicon.ico"><link rel="apple-touch-icon" href="/apple-touch-icon.png"><meta property="og:type" content="website"><meta property="og:locale" content="fr_CA"><meta property="og:title" content="${esc(page.title)}"><meta property="og:description" content="${esc(page.description)}"><meta property="og:url" content="${canonical}"><meta property="og:image" content="${imageUrl(page)}"><link rel="preload" as="image" href="${heroAsset}" fetchpriority="high"><link rel="stylesheet" href="/styles.css"><link rel="stylesheet" href="/laval-master.css?v=20260812-portrait"><script type="application/ld+json">${schema(page)}</script></head>
...
${header()}<main><nav class="breadcrumb" aria-label="Fil d’Ariane"><a href="/">Accueil</a><span>›</span><a href="/secteurs/laval/">Laval</a><span>›</span><span>${page.page}</span></nav>
