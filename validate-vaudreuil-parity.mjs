...
for(const token of ['index,follow','https://www.courtierducoin.ca/secteurs/vaudreuil-soulanges/','Vaudreuil-Dorion','L’Île-Perrot','Saint-Lazare','Hudson','Saint-Zotique','Pourquoi travailler directement avec Pierre','568','418','627 000 $','136','382 223 $','692 500 $'])if(!universal.includes(token))errors.push(`universal: missing ${token}`);
